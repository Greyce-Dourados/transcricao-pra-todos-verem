...
echo "✅ Script criado: cloud-shell-deploy.sh"
echo ""
echo "📋 Como usar no Cloud Shell:"
echo ""
echo "1. Abra o Cloud Shell no console do Google Cloud"
echo "2. Execute o comando:"
echo "   curl -sSL https://raw.githubusercontent.com/SEU_USUARIO/transcricao-pra-todos-verem/main/cloud-run/cloud-shell-deploy.sh | bash"
echo ""
echo "3. Ou faça upload do arquivo e execute:"
echo "   bash cloud-shell-deploy.sh"
echo ""
